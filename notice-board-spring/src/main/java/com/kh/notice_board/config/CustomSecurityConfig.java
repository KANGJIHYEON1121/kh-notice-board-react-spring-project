...
import com.kh.notice_board.filter.JWTCheckFilter;
import com.kh.notice_board.security.handler.APILoginFailHandler;
import com.kh.notice_board.security.handler.APILoginSuccessHandler;
...
public class CustomSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.formLogin(config -> {
			...
			config.usernameParameter("useremail");
